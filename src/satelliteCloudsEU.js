...
const DEEP = 120;       // سحب معتبرة — رُفع لتقليل السحب الخاملة بعد العاصفة
const VERY_DEEP = 155;  // قمم نشطة فعلاً (رُفع من 140 لتصفية السحب الباردة المتبقية بعد انتهاء العاصفة)
